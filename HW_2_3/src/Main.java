 ...
 *  Перегрузить конструкторы. Создать класс Main, в котором создать экземляры класса
 *  Машина с разными параметрами.
 */

/*
 *  Мені не дуже подобається реалізація. Я б краще робив через this(), але це наступне
 *  завдання
 */
public class Main {
