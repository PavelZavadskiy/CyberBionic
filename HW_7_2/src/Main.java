...
/*
* Трохи розширив ф-ционал, можна вводити скількі завгодно, поки не введемо пусту строку ФІО
* Сортування зробив через компаратор
* Перевірку дати через регулярний вираз
* */
